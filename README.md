...
Написан на C# / .NET 8.
![build](https://github.com/tt3read/bugEDIT/actions/workflows/build.yml/badge.svg)
...
---
🧰 Что нужно
Windows + .NET 8 (SDK — для сборки, или готовый `.exe`)
Android Platform Tools (в них `adb` и `fastboot`):
https://developer.android.com/tools/releases/platform-tools
На телефоне — Отладка по USB (Настройки → Для разработчиков)
